...
| 平台 | 状态 | 下载 |
| --- | --- | --- |
| Windows 10/11 x64 | 可用 | [下载安装程序](https://github.com/maxshiila/2kman-release/releases/download/v1.0.0/MAN-1.0.0-win-x64.exe) |
...
[1.0.0 更新说明](RELEASE-NOTES-1.0.0.md)

Windows 安装包 SHA-256：

`D98F1BC05AAC95575E98B20453304EC2609C78CBC2208C34C83D78ADE62D26AA`
